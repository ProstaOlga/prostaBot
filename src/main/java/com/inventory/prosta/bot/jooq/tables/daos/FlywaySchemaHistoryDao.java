...
@Repository
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, jooq.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, jooq.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, jooq.tables.pojos.FlywaySchemaHistory.class, configuration);
    }

    @Override
    public Integer getId(jooq.tables.pojos.FlywaySchemaHistory object) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledRank(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public jooq.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     * Fetch a unique record that has <code>installed_rank = value</code>
     */
    public Optional<jooq.tables.pojos.FlywaySchemaHistory> fetchOptionalByInstalledRank(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfScript(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfChecksum(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledBy(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfExecutionTime(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfSuccess(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
