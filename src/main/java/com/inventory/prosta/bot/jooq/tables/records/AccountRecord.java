...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record5<Long, String, String, String, LocalDate> {
    ...
    @Override
    public AccountRecord value5(LocalDate value) {
        setBirthday(value);
        return this;
    }

    @Override
    public AccountRecord values(Long value1, String value2, String value3, String value4, LocalDate value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Long telegramId, String firstName, String lastName, String userName, LocalDate birthday) {
        super(Account.ACCOUNT);
