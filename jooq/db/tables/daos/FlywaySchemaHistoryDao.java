...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, db.tables.pojos.FlywaySchemaHistory, Integer> {
     ...
     * Fetch a unique record that has <code>installed_rank = value</code>
     */
    public Optional<db.tables.pojos.FlywaySchemaHistory> fetchOptionalByInstalledRank(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
