...
@Repository
public class MediaDao extends DAOImpl<MediaRecord, db.tables.pojos.Media, UUID> {

    /**
     * Create a new MediaDao without any configuration
     */
    public MediaDao() {
        super(Media.MEDIA, db.tables.pojos.Media.class);
    }
    ...
    public MediaDao(Configuration configuration) {
        super(Media.MEDIA, db.tables.pojos.Media.class, configuration);
    }

    @Override
    public UUID getId(db.tables.pojos.Media object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Media> fetchRangeOfId(UUID lowerInclusive, UUID upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Media> fetchById(UUID... values) {
     ...
     */
    public db.tables.pojos.Media fetchOneById(UUID value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<db.tables.pojos.Media> fetchOptionalById(UUID value) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Media> fetchRangeOfMedia(byte[] lowerInclusive, byte[] upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Media> fetchByMedia(byte[]... values) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Media> fetchRangeOfMediaType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Media> fetchByMediaType(String... values) {
