...
@Repository
public class AccountDao extends DAOImpl<AccountRecord, db.tables.pojos.Account, Long> {

    /**
     * Create a new AccountDao without any configuration
     */
    public AccountDao() {
        super(Account.ACCOUNT, db.tables.pojos.Account.class);
    }
    ...
    public AccountDao(Configuration configuration) {
        super(Account.ACCOUNT, db.tables.pojos.Account.class, configuration);
    }

    @Override
    public Long getId(db.tables.pojos.Account object) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Account> fetchRangeOfTelegramId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Account> fetchByTelegramId(Long... values) {
     ...
     */
    public db.tables.pojos.Account fetchOneByTelegramId(Long value) {
     ...
     * Fetch a unique record that has <code>telegram_id = value</code>
     */
    public Optional<db.tables.pojos.Account> fetchOptionalByTelegramId(Long value) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Account> fetchRangeOfFirstName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Account> fetchByFirstName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Account> fetchRangeOfLastName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Account> fetchByLastName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Account> fetchRangeOfUserName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Account> fetchByUserName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<db.tables.pojos.Account> fetchRangeOfBirthday(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<db.tables.pojos.Account> fetchByBirthday(LocalDateTime... values) {
